...
const Register = () => {
  ...
  return (
    <div className="mt-20">
      <div className="w-1/2 h-full border-2 border-secondaryColor mt-5 rounded-full absolute -ml-60"></div>
      <div className="w-2/5 h-5/6 border-2 border-primaryColor mt-20 rounded-full absolute -ml-40"></div>
